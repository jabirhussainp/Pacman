...
namespace Pacman
{
    public class Ghost
    {
        ...
        private bool direction_ok(int x, int y, int ghost)
        {
            ...
            if (Form1.gamemaze.Grid[y, x] < 4 || Form1.gamemaze.Grid[y, x] > 10) { return true; } else { return false; }
        }
        ...
        private void Other_Direction(int direction, int ghost)
        {
            ...
            if (Form1.gamemaze.Grid[yCoordinate[ghost], xCoordinate[ghost]] < 4)
            {
        ...
        public void CheckForPacman()
        {
            ...
            for (int x = 0; x < GhostAmount; x++)
            {
                if (xCoordinate[x] == Form1.pacman.xCrdnte && yCoordinate[x] == Form1.pacman.yCrdnte)
                {
                    switch (State[x])
                    {
